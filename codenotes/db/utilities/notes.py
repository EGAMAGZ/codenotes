...
CREATE_NOTES_TABLE: Final = f"CREATE TABLE IF NOT EXISTS {TABLE_NAME} ({COLUMN_NOTE_ID} INTEGER PRIMARY KEY " \
                            ...
                            f"TEXT NOT NULL, {COLUMN_NOTE_CATEGORY} INTEGER, {COLUMN_NOTE_README} INTEGER NULL " \
                            f"DEFAULT 0, {COLUMN_NOTE_CREATION} DATE NOT NULL, FOREIGN KEY({COLUMN_NOTE_CATEGORY}) " \
